        ...
        <div className="container mx-auto profile pb-10">
            <div className="flex">
                <div className="w-full">
                    <div className="pb-28 box-border bg-white rounded-0.6 app-input-card-border shadow-contactCard">
                                        ...
                                        <div className="flex flex-col mt-1.08 ">
                                            ...
                                            <div className="flex flex-col relative">
                                                <div className="cursor-pointer" onClick={handleDropDownActive}>
                                                    <div className="flex items-center  justify-between p-2 app-result-card-border bg-white w-[16.8125rem] py-2 box-border shadow-inputShadow  rounded-0.3 mt-0.40 font-Poppins text-thinGray font-normal leading-1.31 text-trial">
                                                        <div className="">{selected ? selected : 'Select'}</div>
                                                        <img src={dropdownIcon} alt="" className={isDropDownActive ? 'rotate-180' : 'rotate-0'} />
                                                    </div>
                                                </div>
                                                {isDropDownActive && <div className="app-input-card-border w-full bg-white shadow-integrationCardShadow rounded-0.6 absolute top-12 z-40" onClick={handleDropDownActive}>
                            ...
                            <div className="flex flex-col mt-20">
                                ...
                                <form className="flex flex-col relative mt-1.8 pb-5">
                                    ...
                                    <div className="flex items-center">
                                        <div className="flex absolute left-0 top-32  items-center">
                                            <a
                                                href=""
