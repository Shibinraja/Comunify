    ...
    <div className="container mx-auto memberTable mt-1.8 flex flex-col">
      <div className="flex items-center ">
        ...
        <div className="relative mr-5">
          <div className="flex justify-between items-center px-1.08 app-input-card-border rounded-0.6 box-border w-9.59 h-3.06 cursor-pointer bg-white shadow-profileCard" onClick={handleFilterDropdown} >
            <div className="font-Poppins font-normal text-card text-dropGray leading-1.12">
              Filters
            </div>
            <div>
          ...
          {isFilterDropdownActive && <div className="absolute app-result-card-border box-border bg-white rounded-0.3 w-16.56 shadow-inputShadow z-40 pb-1.56 " onClick={handleFilterDropdown}>
            ...
            <div className="pt-9 flex flex-col">
              ...
              <div className="mt-8 flex items-center">
                ...
                <div className="flex flex-col pl-0.563">
                  <div className="font-medium text-trial text-infoBlack font-Poppins leading-1.31">
                    Emerson Schleifer
                  </div>
              ...
              <div className="bg-activitySubCard rounded flex flex-col pt-2.5 pl-0.81 pb-8 mt-5">
                <div className="flex items-center">
                  ...
                  <div className="pl-0.563 font-Poppins font-medium text-infoBlack text-card leading-1.12">
                    Sent a message in slack
                  </div>
                  <div className="pl-2.5 text-tagChannel font-Poppins font-medium text-card leading-1.12">
                    #channel 1
                  </div>
                </div>
                ...
                <div className="mt-1.18 flex relative">
                  <div className="font-Poppins font-medium text-card leading-1.12 text-tag underline cursor-pointer">
                    VIEW ON SLACK
                  </div>
              ...
              <div className="mt-7">
                <h3 className="text-profileBlack text-error font-Poppins font-medium leading-5">
                  Tags
                </h3>
                <div className="flex pt-2.5 flex-wrap">
                  <div className="flex  tags bg-tagSection items-center justify-evenly rounded w-6.563 py-1">
                    <div className="font-Poppins text-card font-normal leading-5 text-profileBlack">
                      Influencer
                    </div>
