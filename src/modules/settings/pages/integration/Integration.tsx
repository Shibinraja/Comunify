            ...
            <div className="flex mt-1.8 flex-wrap w-full pb-1.68 border-b border-bottom-card">
                <div className="app-input-card-border shadow-integrationCardShadow w-8.5 h-11.68 rounded-0.6 box-border bg-white flex flex-col items-center justify-center mr-5">
                    ...
                    <Button
                        type="button"
                        text="disconnect"
                        className="btn-disconnect-gradient shadow-contactCard font-Poppins text-white font-medium leading-5 text-error mt-0.81 rounded h-8 w-6.56 cursor-pointer hover:shadow-buttonShadowHover transition ease-in duration-300"
                    >
                        Disconnect
                    </Button>
                </div>
                ...
                <div className="flex mt-1.8 flex-wrap w-full">
                    <div className="app-input-card-border shadow-integrationCardShadow w-8.5 h-11.68 rounded-0.6 box-border bg-white flex flex-col items-center justify-center mr-5">
                        ...
                        <Button
                            type="button"
                            text="disconnect"
                            className="bg-connectButton shadow-contactCard font-Poppins text-white font-medium leading-5 text-error mt-0.81 rounded h-8 w-6.56 cursor-pointer hover:shadow-buttonShadowHover transition ease-in duration-300 btn-gradient"
                        >
                            Connect
                        </Button>
                    </div>
