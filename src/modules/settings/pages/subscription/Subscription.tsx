    ...
    <div className="subscription mt-2.625 pl-5">
      ...
      <div className="flex border bg-paymentSubscription w-full h-8.37 shadow-paymentSubscriptionCard box-border rounded-0.9 relative items-center px-[27px] mt-1.8">
        <div className="flex flex-col">
          <div className="font-semibold font-Poppins leading-1.56 text-infoBlack text-base">
            Current Plan
          </div>
        ...
        <div className="flex flex-col pl-[98px]">
          ...
          <div className="flex gap-4">
            <div className="flex items-center gap-x-1">
              ...
              <div className="text-renewalGray text-error font-Poppins font-normal leading-1.31">
                Single User
              </div>
            </div>
            <div className="flex items-center gap-x-1">
        ...
        <div className="flex mt-1.8">
          <div className="bg-paymentSubscription box-border w-13.31 pb-5 shadow-paymentSubscriptionCard flex flex-col items-center justify-center border-gradient-rounded">
            <h5 className="flex items-center justify-center">
              <span className="price font-Poppins font-semibold leading-2.8 text-renewalPrice ">
                $29
              </span>
              <span className="text-renewalPlan font-medium font-Poppins leading-1.43">
                /month
              </span>
            </h5>
      ...
      <div className="renewal mt-[44px]">
        <div className="flex justify-between px-5 items-center">
          ...
          <div className="flex gap-4 items-center">
            <div className="text-renewalLightGray text-trial font-medium leading-1.31 font-Poppins">
              NO
            </div>
            <ToggleButton value={toggle} onChange={() => settoggle(toggle ? false : true)} />
            <div className="text-trial font-medium leading-1.31 font-Poppins">
              YES
            </div>
          </div>
        </div>
