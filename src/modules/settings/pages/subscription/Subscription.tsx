          ...
          <div className="flex mt-1.8">
            <div className="bg-paymentSubscription dark:bg-thirdDark box-border w-13.31 pb-5 shadow-paymentSubscriptionCard flex flex-col items-center justify-center border-gradient-rounded">
              <h5 className="flex items-center justify-center">
                ...
                <span className="text-renewalPlan font-medium font-Poppins leading-1.43 dark:text-greyDark">/month</span>
              </h5>
            ...
            <div className="flex flex-col ml-5 bg-paymentSubscription dark:bg-thirdDark w-13.31 h-14.31 box-border pb-10 shadow-paymentSubscriptionCard pt-[49px] pl-5 border-gradient-rounded">
              ...
              <div className="flex items-center gap-x-1 mt-[8px]">
                ...
                <div className="font-Poppins text-error text-renewalGray dark:text-greyDark leading-1.31 font-normal">Single User</div>
              </div>
              <div className="flex items-center gap-x-1">
                <div className="w-[12px]">
                  <img src={tickIcon} alt="" />
                </div>
                <div className="font-Poppins text-error text-renewalGray dark:text-greyDark leading-1.31 font-normal">5 Platforms</div>
              </div>
              <div className="flex items-center gap-x-1">
                <div className="w-[12px]">
                  <img src={tickIcon} alt="" />
                </div>
                <div className="font-Poppins text-error text-renewalGray dark:text-greyDark leading-1.31 font-normal">Customizable Reports</div>
              </div>
              <div className="flex items-center gap-x-1">
                <div className="w-[12px]">
                  <img src={tickIcon} alt="" />
                </div>
                <div className="font-Poppins text-error text-renewalGray dark:text-greyDark leading-1.31 font-normal">Configurable Dashboard</div>
              </div>
            </div>
          </div>
        </div>
        <div className="renewal mt-[44px] mb-10">
          <div className="flex justify-between  items-center">
            <div className="flex flex-col">
              ...
              <p className="text-renewalGray font-normal  text-trial leading-1.31 mt-1 dark:text-greyDark">Your auto renewal is active</p>
            </div>
