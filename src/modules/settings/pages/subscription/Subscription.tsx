  ...
  return (
    <TabPanel hidden={hidden}>
      <div className="subscription mt-2.625 pl-5">
        <h3 className="text-infoBlack font-Poppins font-semibold text-base leading-1.56">Subscription</h3>
        ...
        <div className="flex border bg-paymentSubscription w-full h-8.37 shadow-paymentSubscriptionCard box-border rounded-0.9 relative items-center px-[27px] mt-1.8">
          <div className="flex flex-col">
            <div className="font-semibold font-Poppins leading-1.56 text-infoBlack text-base">Current Plan</div>
          ...
          <div className="flex flex-col pl-[98px]">
            ...
            <div className="flex gap-4">
              <div className="flex items-center gap-x-1">
                ...
                <div className="text-renewalGray text-error font-Poppins font-normal leading-1.31">Single User</div>
              </div>
              <div className="flex items-center gap-x-1">
                <div className="w-[12px]">
                  <img src={tickIcon} alt="" className="bg-cover" />
                </div>
                <div className="text-renewalGray text-error font-Poppins font-normal leading-1.31">5 Platforms</div>
              </div>
              <div className="flex items-center gap-x-1">
                <div className="w-[12px]">
                  <img src={tickIcon} alt="" className="bg-cover" />
                </div>
                <div className="text-renewalGray text-error font-Poppins font-normal leading-1.31">Customizable Reports</div>
              </div>
            </div>
          </div>
        ...
        <div className="upgrade mt-1.8 ">
          <h3 className="font-Poppins font-semibold text-infoBlack leading-2.18 text-infoData">Upgrade</h3>
