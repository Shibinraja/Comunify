...
export default function ActivitiesTab() {
  ...
  return (
    <div className="w-full h-full   box-border bg-white dark:bg-secondaryDark dark:text-white  rounded-0.6 mt-1.868 border  border-borderPrimary dark:border-borderDark shadow-profileCard  h-[85%]">
