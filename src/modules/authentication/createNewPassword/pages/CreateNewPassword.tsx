                  ...
                  <div className="password relative">
                    <Input
                      ...
                      className={`h-4.5 relative rounded-lg pr-3.12 bg-white p-2.5 focus:outline-none placeholder:font-normal placeholder:text-secondaryGray placeholder:text-base placeholder:leading-6 placeholder:font-Inter font-Inter box-border ${
                        touched.password && errors.password ? 'boder-lightRed h-4.5 relative rounded-lg pr-3.12 bg-white p-2.5 focus:outline-none placeholder:font-normal placeholder:text-secondaryGray placeholder:text-base placeholder:leading-6 placeholder:font-Inter font-Inter box-border' : ''
                      }`}
                      onBlur={handleBlur}
                  ...
                  className={`password relative ${
                   errors.password ==='Password must have one uppercase, one lowercase, a digit and special characters'  ? 'password relative mt-8' : 'mt-8 '
                    ...
                    <Input
                      ...
                      className={`h-4.5 relative rounded-lg pr-3.12 bg-white p-2.5 focus:outline-none placeholder:font-normal placeholder:text-secondaryGray placeholder:text-base placeholder:leading-6 placeholder:font-Inter font-Inter box-border ${
                        touched.confirmPassword && errors.confirmPassword ? 'boder-lightRed h-4.5 relative rounded-lg pr-3.12 bg-white p-2.5 focus:outline-none placeholder:font-normal placeholder:text-secondaryGray placeholder:text-base placeholder:leading-6 placeholder:font-Inter font-Inter box-border' : ''
                      }`}
                      onBlur={handleBlur}
                      onChange={handleChange}
