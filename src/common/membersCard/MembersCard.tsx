        ...
        <div className="flex  flex-col items-center justify-center bg-member1 rounded-0.9 w-full h-8.34 cursor-pointer">
          {membersCountAnalyticsLoading ? (
            ...
            <Fragment>
              ...
              <div className="text-[10px] xl:text-card font-Poppins font-normal leading-1.12 text-status mt-0.151">{totalMembers.analyticMessage}</div>
            </Fragment>
          )}
        </div>
        <div className=" flex-col items-center justify-center flex bg-member2 rounded-0.9 w-full h-8.34 cursor-pointer">
          {membersCountAnalyticsLoading ? (
            ...
            <Fragment>
              ...
              <div className="text-[10px] xl:text-card  font-Poppins font-normal leading-1.12 text-status mt-0.151">{newMembers.analyticMessage}</div>
            </Fragment>
          )}
        </div>
        <div className=" flex-col items-center justify-center flex bg-member3 rounded-0.9 w-full h-8.34 cursor-pointer">
          {membersActivityAnalyticsLoading ? (
            ...
            <Fragment>
              ...
              <div className="text-[10px] xl:text-card  font-Poppins font-normal leading-1.12 text-status mt-0.151">{activeMembers.analyticMessage}</div>
            </Fragment>
          )}
        </div>
        <div className=" flex-col items-center justify-center flex bg-member4 rounded-0.9 w-full h-8.34 cursor-pointer">
          {membersActivityAnalyticsLoading ? (
            ...
            <Fragment>
              ...
              <div className="text-[10px] xl:text-card  font-Poppins font-normal leading-1.12 text-status mt-0.151">{inActiveMembers.analyticMessage}</div>
            </Fragment>
          )}
        </div>
      </div>
