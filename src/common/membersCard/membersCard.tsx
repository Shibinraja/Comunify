const MembersCard = () => {
    return (
        ...
        <div className="flex gap-2.28">
          ...
          <div className=" flex-col items-center justify-center flex bg-member2 rounded-0.9 w-13.7 h-8.34 cursor-pointer">
            <div className="text-infoBlack font-Poppins font-semibold text-signIn leading-3.18">
              4.3k
            </div>
            <div className="text-Poppins font-semibold text-infoBlack text-member leading-4">
          ...
          <div className=" flex-col items-center justify-center flex bg-member3 rounded-0.9 w-13.7 h-8.34 cursor-pointer">
            <div className="text-infoBlack font-Poppins font-semibold text-signIn leading-3.18">
              2.1k
            </div>
            <div className="text-Poppins font-semibold text-infoBlack text-member leading-4">
          ...
          <div className=" flex-col items-center justify-center flex bg-member4 rounded-0.9 w-13.7 h-8.34 cursor-pointer">
            <div className="text-infoBlack font-Poppins font-semibold text-signIn leading-3.18">
              541
            </div>
            <div className="text-Poppins font-semibold text-infoBlack text-member leading-4">
